      ...
      <section className="section-padding bg-white">
        <div className="container-page">
          <SectionHeader
            ...
            subtitle="Membership in the Florida Rugby Chamber means business connections rooted in a shared passion for the This past year, a student-athlete and president of the university rugby club, who happened to have an internship at NASA had trouble finding a job upon graduation. Previously, there was no mechanism for the rugby community to help someone like that. Now, there is. game."
          />
